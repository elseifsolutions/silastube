...
var UT_RATING_IMG_HOVER='https://web.archive.org/web/20081128223126/http://s.ytimg.com/yt/img/star_hover-vfl2056.gif';
var UT_RATING_IMG_HALF='icn_star_half_19x20';
var UT_RATING_IMG_BG='icn_star_empty_19x20';
var UT_RATING_IMG_REMOVED='https://web.archive.org/web/20081128223126/http://s.ytimg.com/yt/img/star_removed-vfl2028.gif';
...
var innerHTMLContent='\
	<form name="'+reply_comment_form+'" id="'+reply_comment_form+'" onSubmit="return false" method="post" action="/comment_servlet?add_comment=1&comment_type='+comment_type+'" >\
		...
		<input align="left" type="button" name="preview_comment_button" \
...
var temp_HTML='<img src="https://web.archive.org/web/20081128223126/http://s.ytimg.com/yt/img/icn_loading_animated-vfl24663.gif">';
...
var playerDiv=_gel('watch-player-div');
var playerEmbed=_gel('movie_player');
var inflateDiv=_gel('watch-other-vids-inflate');
if(newMode!=widePlayerMode){
widePlayerMode=newMode;
if(widePlayerMode){
addClass(playerDiv,"watch-wide-mode");
addClass(playerEmbed,"watch-wide-mode");
addClass(inflateDiv,"watch-wide-mode");
}else{
removeClass(playerDiv,"watch-wide-mode");
removeClass(playerEmbed,"watch-wide-mode");
removeClass(inflateDiv,"watch-wide-mode");
}
}
}
...
var embedCode='<object width="425" height="'+height+'"><param name="movie" value="'+embedUrl+query+'"><\/param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="'+embedUrl+query+'" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="425" height="'+height+'"><\/embed><\/object>';
...
_gel(resultsDivName).innerHTML="<img src='https://web.archive.org/web/20081128223126/http://s.ytimg.com/yt/img/LoadingGraphic-vfl3869.gif'>";
if(_gel("watchSearchSubmit")){
...
var previewSwf=new SWFObject('https://web.archive.org/web/20081128223126/http://s.ytimg.com/yt/swf/textreader-vfl58814.swf',"preview_comment","1","1",8);
...
originalVideo=elements[0].id.replace(/^v_/,"");
onChangeEpisodeInner(vlentry,originalVideo);
}
}
...
onChangeEpisodeInner(fromEl,toVideo)
}
var gLoadingEpisode=false;
function onChangeEpisodeInner(fromEl,toVideo){
if(gLoadingEpisode){
return;
}
...
script.setAttribute("src","https://web.archive.org/web/20081128223126/http://maps.google.com/maps?file=api&v=2.x&key="+gMapsApiKey+"&c&async=2&callback="+callbackName+"&hl="+mapLanguage);
...
function getNextListRow(loopPlayback,offset){
if(!playnextFrom||!watchIsPlayingAll){
return null;
}
...
var nextRow=getNextListRow(loopPlayback);
if(nextRow){
if(suffix==null){
suffix="";
}
...
fillQuicklistRow(newRow,videoCount,"","https://web.archive.org/web/20081128223126/http://s.ytimg.com/yt/img/pixel-vfl73.gif",MSG_Loading,"","");
...
this.addImage(new ytImage("https://web.archive.org/web/20081128223126/http://s.ytimg.com/yt/img/pixel-vfl73.gif","","&nbsp;","","&nbsp;","",true));
}
}
...
new Image().src=['https://web.archive.org/web/20081128223126/http://csi.gstatic.com/csi?v=2&s=youtube&action=',action,
...
/*
     FILE ARCHIVED ON 22:31:26 Nov 28, 2008 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 02:14:16 Jan 17, 2025.
...
playback timings (ms):
  ...
  esindex: 0.009
  cdx.remote: 31.995
  LoadShardBlock: 259.063 (3)
  PetaboxLoader3.resolve: 170.179 (2)
  PetaboxLoader3.datanode: 162.426 (4)
  load_resource: 102.438
*/