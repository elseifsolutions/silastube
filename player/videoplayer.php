<?php
$videoFilePath = "/promo.mp4"; // Replace with the actual path to your video file
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link rel="stylesheet" href="/player/html5-player.css">
...
<body style="font: 12px Arial, sans-serif;background: black;">
  <div class="embed-container">
    <video class="html5_video" src="<?php echo htmlspecialchars($videoFilePath); ?>">
    </video>
  ...
  <script src="/player/html5-player.js"></script>
  <script>
